...
<div class="row">
<h1 class="title">Jurusan Teknik</h1><br><br>
...
// jalankan query
$result = mysqli_query($link, "SELECT * FROM teknik ");
...
while ($row=mysqli_fetch_array($result,MYSQLI_ASSOC)) { 
    ...
    <a href="../pages/jurusan/pages/detail_jurusan_teknik.php?nama='<?php echo $row["nama"];?>'"  class="btn btn-primary btn-lg"><?php echo $row["nama"]?></a><br><br><br><br>
    </div>
    </div>
