...
<div class="container-fluid col-md-12 konten">
  <div class="container-fluid kotak-register">
    <form action="action/action-daftar.php" method="post">
      <center><h3>Silakan Isi Form Pendaftaran</h3> </center>
      <br><br>
      <input type="text" name="fullname" placeholder="Nama Lengkap" id="input" required="required">
      <br><br>
      <input type="email" name="email" placeholder="Email" id="input" required="required">
      <br><br>
      <input type="text" name="username" placeholder="Username" id="input" required="required">
      <br><br>
      <input type="password" name="password" placeholder="Password" id="input" required="required">
      <br><br>
      <input type="submit" name="masuk" class="pull-right btn btn-info" value="Daftar" id="masuk">
    </form>
    <br>
